...
class DiseaseInfoService {
  static final List<DiseaseInfoModel> _diseases = [
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Site Selection:** Plant in well-drained soil with adequate sunlight.\n"
          "2.  **Balanced Nutrition:** Apply appropriate, balanced fertilizers based on soil tests.\n"
          "3.  **Consistent Watering:** Provide regular, deep watering, especially during dry periods, to ensure proper fruit development.\n"
          "4.  **Proper Pruning:** Prune annually to maintain tree structure, promote air circulation, and remove any dead or weak branches.\n"
          "5.  **Pest & Disease Monitoring:** Regularly inspect the tree for early signs of issues and implement integrated pest management (IPM) strategies proactively.",
    ),
    DiseaseInfoModel(
      ...
      treatment: "1.  **Resistant Varieties:** Plant resistant cherry varieties when possible.\n"
          "2.  **Pruning & Air Circulation:** Prune trees to open up the canopy, improve air circulation, and allow better light penetration, which helps reduce humidity.\n"
          "3.  **Fungicides:** Apply fungicides containing active ingredients like Myclobutanil (e.g., Immunox), Propiconazole, Triflumizole, or Sulfur. Begin applications at the first sign of disease and continue according to product label, especially during periods favorable for powdery mildew development.\n"
          "4.  **Horticultural Oils/Neem Oil:** For organic control or less severe cases, horticultural oils or neem oil can be effective, but require thorough coverage and repeat applications. Apply when temperatures are not extreme to avoid plant damage.\n"
          "5.  **Sanitation:** Remove and destroy severely infected plant parts to reduce inoculum.",
    ),
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Adequate Sunlight:** Ensure the plant receives at least 6-8 hours of direct sunlight daily.\n"
          "2.  **Proper Watering:** Water consistently, keeping the soil moist but not waterlogged. Allow the top inch of soil to dry out between waterings.\n"
          "3.  **Balanced Fertilization:** Use a balanced fertilizer during vegetative growth and switch to one higher in phosphorus and potassium for flowering and fruiting.\n"
          "4.  **Pest & Disease Scouting:** Regularly inspect plants for early signs of pests or diseases to allow for timely intervention.\n"
          "5.  **Good Air Circulation:** Space plants appropriately to promote air flow and reduce humidity, which can deter fungal diseases.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in rich, well-drained, slightly acidic soil (pH 6.0-6.5) with partial shade.\n"
          "2.  **Balanced Fertilization:** Apply fertilizers tailored to coffee's needs, based on soil analysis.\n"
          "3.  **Consistent Watering:** Ensure consistent moisture, especially during dry seasons, but avoid waterlogging.\n"
          "4.  **Pruning:** Regularly prune to maintain plant shape, promote air circulation, and encourage berry production.\n"
          "5.  **Pest & Disease Scouting:** Conduct routine inspections for any early signs of pests or diseases to allow for prompt, targeted intervention.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Planting:** Plant at the correct time, depth, and spacing for your region.\n"
          "2.  **Balanced Nutrition:** Apply appropriate NPK fertilizers and micronutrients based on soil tests and crop needs.\n"
          "3.  **Adequate Water:** Ensure consistent moisture through rainfall or irrigation, especially during critical growth stages (tasseling, silking, grain fill).\n"
          "4.  **Weed Control:** Implement effective weed management to reduce competition for resources.\n"
          "5.  **Pest & Disease Scouting:** Regularly monitor fields for early detection of pests or diseases and apply integrated pest management (IPM) strategies proactively.\n"
          "6.  **Hybrid Selection:** Choose hybrids adapted to your local climate and with good natural resistance to common diseases.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in rich, well-drained soil with full sunlight (6-8 hours daily).\n"
          "2.  **Consistent Watering:** Keep soil consistently moist, especially during flowering and fruiting. Avoid overhead watering to keep leaves dry.\n"
          "3.  **Balanced Fertilization:** Provide balanced nutrients, supplementing with phosphorus and potassium during fruiting.\n"
          "4.  **Support:** Use trellises or stakes to support vines, promoting air circulation and keeping fruit off the ground.\n"
          "5.  **Pest & Disease Scouting:** Regularly inspect plants for early signs of issues and address them promptly with integrated pest management (IPM) strategies.",
    ),
    DiseaseInfoModel(
      ...
      treatment: "1.  **Diagnosis:**\n"
          "\t•  Carefully observe symptoms to identify the specific disease if possible. Consult an arborist or agricultural expert for confirmation.\n"
          "2.  **Sanitation:**\n"
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in full sun with well-drained, fertile soil.\n"
          "2.  **Balanced Fertilization:** Apply balanced fertilizers appropriate for fruit trees, based on soil analysis.\n"
          "3.  **Consistent Watering:** Provide regular deep watering, especially during dry periods and fruit development.\n"
          "4.  **Proper Pruning:** Prune annually to maintain tree shape, remove dead/weak branches, and ensure good air circulation within the canopy.\n"
          "5.  **Pest & Disease Monitoring:** Regularly inspect the tree for early signs of pests or diseases and implement integrated pest management (IPM) strategies proactively.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Site & Soil:** Plant in full sun with well-drained, fertile soil, ideally on a slope for good drainage.\n"
          "2.  **Proper Training & Pruning:** Establish a suitable trellis system and prune annually to manage vine vigor, optimize fruit production, and improve air circulation.\n"
          "3.  **Balanced Nutrition:** Apply fertilizers based on soil tests to meet the vine's specific nutrient requirements throughout its growth cycle.\n"
          "4.  **Adequate Watering:** Provide consistent moisture, especially during dry periods, but avoid overwatering. Drip irrigation is often preferred.\n"
          "5.  **Pest & Disease Monitoring:** Regularly inspect vines for early signs of issues and implement integrated pest management (IPM) strategies proactively.\n"
          "6.  **Resistant Varieties:** Choose grape varieties (Vitis vinifera or hybrids) known for their resistance to common diseases in your region.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in full sun with well-drained, fertile soil. Jamun is relatively adaptable.\n"
          "2.  **Balanced Fertilization:** Provide balanced nutrients, especially for young trees and during fruiting periods, based on soil analysis.\n"
          "3.  **Adequate Watering:** Ensure consistent moisture, particularly during flowering and fruiting, but avoid waterlogging.\n"
          "4.  **Proper Pruning:** Prune regularly to maintain tree shape, remove dead or weak wood, and encourage good air circulation.\n"
          "5.  **Pest & Disease Monitoring:** Conduct routine inspections for any early signs of pests or diseases to allow for prompt, targeted intervention.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in full sun (at least 8 hours daily) with well-drained, slightly acidic soil.\n"
          "2.  **Balanced Fertilization:** Apply citrus-specific fertilizers regularly, providing essential macro and micronutrients.\n"
          "3.  **Consistent Watering:** Water deeply and regularly, allowing the topsoil to dry slightly between waterings. Avoid waterlogging.\n"
          "4.  **Proper Pruning:** Prune to maintain tree shape, remove dead/weak branches, improve air circulation, and promote fruit production.\n"
          "5.  **Pest & Disease Monitoring:** Regularly inspect the tree for early signs of pests or diseases and implement integrated pest management (IPM) strategies proactively.\n"
          "6.  **Protection:** Protect young trees from frost and ensure adequate air circulation around the trunk.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in full sun with well-drained, deep, fertile soil.\n"
          "2.  **Balanced Fertilization:** Apply appropriate mango-specific fertilizers, ensuring adequate nitrogen for vegetative growth and phosphorus/potassium for flowering and fruiting.\n"
          "3.  **Consistent Watering:** Provide regular deep watering, especially during dry seasons and critical growth stages (flowering, fruit set, fruit development). Avoid waterlogging.\n"
          "4.  **Proper Pruning:** Prune young trees for good structure and mature trees to maintain size, improve air circulation, remove dead/weak wood, and encourage fruit production.\n"
          "5.  **Pest & Disease Monitoring:** Regularly inspect the tree for early signs of pests or diseases and implement integrated pest management (IPM) strategies proactively. This includes regular scouting for common issues like anthracnose or powdery mildew, especially during humid periods.\n"
          "6.  **Weed Control:** Keep the area around the tree base free of weeds to reduce competition for nutrients and water.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in full sun with well-drained soil.\n"
          "2.  **Balanced Fertilization:** Apply appropriate fertilizers based on soil tests to meet the peach tree's nutritional needs throughout the season.\n"
          "3.  **Consistent Watering:** Provide regular, deep watering, especially during dry periods and fruit development.\n"
          "4.  **Proper Pruning:** Prune annually during dormancy (winter) to maintain tree shape, promote air circulation, remove dead/diseased wood, and encourage fruit production.\n"
          "5.  **Pest & Disease Monitoring:** Regularly inspect the tree for early signs of pests or diseases and implement integrated pest management (IPM) strategies proactively.\n"
          "6.  **Weed Control:** Keep the area around the tree base free of weeds to reduce competition and improve air flow.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Sunlight:** Provide at least 6-8 hours of direct sunlight daily.\n"
          "2.  **Well-Drained Soil:** Plant in fertile, well-drained soil rich in organic matter.\n"
          "3.  **Consistent Watering:** Keep soil consistently moist but not waterlogged. Avoid extreme fluctuations.\n"
          "4.  **Balanced Fertilization:** Use a balanced fertilizer during vegetative growth, transitioning to one higher in phosphorus and potassium for flowering and fruiting.\n"
          "5.  **Proper Spacing:** Ensure adequate spacing between plants for good air circulation.\n"
          "6.  **Pest & Disease Scouting:** Regularly inspect plants for early signs of pests or diseases and address them promptly using integrated pest management (IPM) techniques.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in full sun with well-drained, slightly acidic to alkaline soil.\n"
          "2.  **Balanced Fertilization:** Apply appropriate fertilizers based on soil tests to meet the tree's nutritional needs.\n"
          "3.  **Consistent Watering:** Provide regular deep watering, especially during dry periods and fruit development. Pomegranates are drought-tolerant once established but benefit from regular water.\n"
          "4.  **Proper Pruning:** Prune annually to maintain tree structure, promote air circulation, remove suckers and dead/weak wood, and encourage fruit production.\n"
          "5.  **Pest & Disease Monitoring:** Regularly inspect the tree for early signs of pests (e.g., aphids, mealybugs) or diseases and implement integrated pest management (IPM) strategies proactively.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Use Certified Seed Potatoes:** Always plant certified disease-free seed potatoes to prevent introducing pathogens.\n"
          "2.  **Optimal Planting:** Plant at the correct depth and spacing in well-drained, fertile soil.\n"
          "3.  **Balanced Fertilization:** Apply appropriate NPK fertilizers and micronutrients based on soil tests and crop needs.\n"
          "4.  **Consistent Watering:** Provide consistent moisture, especially during tuber formation and bulking. Avoid extreme fluctuations.\n"
          "5.  **Proper Hilling:** Hill soil around plants as they grow to protect developing tubers from light (prevent greening) and disease.\n"
          "6.  **Weed Control:** Implement effective weed management to reduce competition for resources and improve air circulation.\n"
          "7.  **Pest & Disease Scouting:** Regularly monitor fields for early detection of pests (e.g., Colorado potato beetle, aphids) or diseases and apply integrated pest management (IPM) strategies proactively.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Planting:** Use certified, high-quality seeds. Plant at appropriate spacing and depth.\n"
          "2.  **Balanced Fertilization:** Apply nitrogen, phosphorus, and potassium as per soil test recommendations and crop stage. Include micronutrients if deficient.\n"
          "3.  **Proper Water Management:** Maintain optimal water levels for flooded rice (paddy) or ensure consistent moisture for upland rice, avoiding water stress.\n"
          "4.  **Weed Control:** Implement timely and effective weed management (manual, chemical, or biological) to reduce competition for resources.\n"
          "5.  **Pest & Disease Monitoring:** Regularly scout fields for early detection of pests (e.g., stem borers, leaf folders, plant hoppers) or diseases and apply integrated pest management (IPM) strategies proactively.\n"
          "6.  **Resistant Varieties:** Choose rice varieties adapted to your local climate and with good natural resistance to common local pests and diseases.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Use High-Quality Seeds:** Plant certified, healthy soybean seeds adapted to your region.\n"
          "2.  **Optimal Planting:** Plant at the correct time, depth, and spacing. Ensure good soil preparation.\n"
          "3.  **Balanced Fertilization:** Apply fertilizers based on soil tests, ensuring adequate nitrogen (if not relying solely on nodulation), phosphorus, and potassium. Inoculate seeds with *Bradyrhizobium japonicum* for nitrogen fixation.\n"
          "4.  **Water Management:** Provide consistent moisture, especially during critical growth stages like flowering and pod fill. Avoid waterlogging.\n"
          "5.  **Weed Control:** Implement effective weed management to reduce competition for resources.\n"
          "6.  **Pest & Disease Monitoring:** Regularly scout fields for early detection of pests (e.g., defoliators, pod feeders) or diseases and apply integrated pest management (IPM) strategies proactively.\n"
          "7.  **Crop Rotation:** Practice crop rotation to break pest and disease cycles and improve soil health.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Site Selection:** Plant in full sun (6-8 hours daily) with well-drained, fertile, slightly acidic soil.\n"
          "2.  **Proper Planting:** Ensure crowns are at soil level, not too deep or too shallow.\n"
          "3.  **Consistent Watering:** Keep soil consistently moist, especially during fruit development. Use drip irrigation or water at the base to keep leaves dry.\n"
          "4.  **Balanced Fertilization:** Apply appropriate, balanced fertilizers based on soil tests to support healthy growth and fruiting.\n"
          "5.  **Mulching:** Use straw mulch to keep berries clean, suppress weeds, and retain soil moisture.\n"
          "6.  **Pest & Disease Monitoring:** Regularly inspect plants for early signs of pests (e.g., slugs, aphids) or diseases and implement integrated pest management (IPM) strategies proactively.\n"
          "7.  **Renovation (for June-bearing):** Renovate plants after harvest by mowing leaves, narrowing rows, and fertilizing to promote new growth.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Use Healthy Planting Material:** Plant only healthy, disease-free setts (seed cane).\n"
          "2.  **Optimal Soil Preparation:** Ensure good soil tilth, drainage, and fertility prior to planting.\n"
          "3.  **Balanced Fertilization:** Apply nitrogen, phosphorus, and potassium as per soil test recommendations and crop stage. Ensure adequate micronutrients.\n"
          "4.  **Adequate Water:** Provide consistent moisture through rainfall or irrigation, especially during critical growth periods.\n"
          "5.  **Weed Control:** Implement timely and effective weed management to reduce competition for resources.\n"
          "6.  **Pest & Disease Monitoring:** Regularly scout fields for early detection of pests (e.g., borers, mealybugs) or diseases and apply integrated pest management (IPM) strategies proactively.\n"
          "7.  **Resistant Varieties:** Choose sugarcane varieties adapted to your local climate and with good natural resistance to common local pests and diseases.",
    ),
    DiseaseInfoModel(
      ...
      possibleCauses: "The fungus primarily spreads through:\n"
          "\t•  **Infected Planting Material:** Using infected setts (seed cane) is the main way the disease is introduced into new fields. The fungus grows into the plant from the infected sett.\n"
          "\t•  **Contaminated Tools:** Cutting tools can spread spores from diseased to healthy stalks.\n"
          "The disease thrives in:\n"
          "\t•  **High Humidity & Warm Temperatures:** These conditions favor fungal growth and spore production.\n"
          "\t•  **Waterlogging:** Poor drainage can weaken plants and make them more susceptible.",
      treatment: "1.  **Use Certified Disease-Free Seed Cane:**\n"
          "\t•  **Crucial.** Plant only healthy, certified disease-free setts from reputable nurseries or heat-treated cane. Inspect setts carefully for internal reddish discoloration before planting.\n"
          "2.  **Resistant Varieties:**\n"
          "\t•  Plant red rot-resistant sugarcane varieties. This is the most effective long-term control measure. Consult local research institutions for recommended varieties.\n"
          "3.  **Sanitation:**\n"
          "\t•  Rogue out (remove and destroy) infected stools (clumps of plants) and plant debris from affected fields. Burn severely infected cane.\n"
          "\t•  Disinfect cutting tools regularly using a bleach solution (e.g., 10%) or other effective disinfectant when moving between plants or fields, especially after cutting diseased cane.\n"
          "4.  **Crop Rotation:**\n"
          "\t•  Rotate fields with non-sugarcane crops for at least 1-2 years to break the disease cycle and reduce inoculum in the soil.\n"
          "5.  **Water Management:**\n"
          "\t•  Ensure good drainage to avoid waterlogging, which can predispose plants to infection.\n"
          "6.  **Avoid Ratooning (Regrowth) Infected Fields:**\n"
          "\t•  If a field is heavily infected with red rot, do not allow it to ratoon (regrow from stubble) as the disease will persist and worsen.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in well-drained, acidic soil (pH 4.5-5.5) with adequate rainfall or irrigation.\n"
          "2.  **Balanced Fertilization:** Apply specialized tea fertilizers (high in nitrogen, balanced with P & K) based on soil tests and target yield, often in split doses.\n"
          "3.  **Consistent Moisture:** Ensure continuous moisture, especially during dry periods, but avoid waterlogging.\n"
          "4.  **Proper Pruning & Plucking:** Regular plucking (harvesting of tender shoots) encourages new growth. Periodic pruning maintains bush structure and health.\n"
          "5.  **Shade Management:** Provide appropriate shade (depending on tea type and climate) to protect bushes from excessive sun and maintain humidity.\n"
          "6.  **Pest & Disease Monitoring:** Regularly scout tea fields for early detection of pests (e.g., mites, thrips, tea mosquito bug) or diseases and apply integrated pest management (IPM) strategies proactively.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Optimal Growing Conditions:** Plant in full sun with well-drained, fertile soil.\n"
          "2.  **Use Certified Disease-Free Seeds/Transplants:** Start with healthy plant material.\n"
          "3.  **Balanced Fertilization:** Apply appropriate, balanced fertilizers based on soil tests to meet the tomato plant's nutritional needs throughout its growth cycle.\n"
          "4.  **Consistent Watering:** Provide regular, deep watering, especially during fruit development. Avoid overhead watering to keep foliage dry.\n"
          "5.  **Proper Staking/Trellising:** Support plants to keep foliage and fruit off the ground, improving air circulation and reducing disease risk.\n"
          "6.  **Pruning:** Prune suckers and lower leaves (especially those touching the ground) to improve air circulation and concentrate energy on fruit production.\n"
          "7.  **Pest & Disease Monitoring:** Regularly inspect plants for early signs of pests (e.g., aphids, hornworms, spider mites) or diseases and implement integrated pest management (IPM) strategies proactively.",
    ),
    DiseaseInfoModel(
    ...
    DiseaseInfoModel(
      ...
      possibleCauses: "—",
      treatment: "1.  **Use Certified, High-Quality Seeds:** Plant certified disease-free and high-germination seeds adapted to your climate.\n"
          "2.  **Optimal Planting:** Plant at the correct depth, spacing, and time for your region.\n"
          "3.  **Balanced Fertilization:** Apply nitrogen, phosphorus, potassium, and micronutrients based on soil tests and crop needs. Proper nitrogen management is crucial.\n"
          "4.  **Weed Control:** Implement timely and effective weed management to reduce competition for resources.\n"
          "5.  **Water Management:** Provide adequate moisture, especially during critical growth stages (e.g., tillering, booting, grain fill), but avoid waterlogging.\n"
          "6.  **Pest & Disease Monitoring:** Regularly scout fields for early detection of pests (e.g., aphids, Hessian fly) or diseases (e.g., rusts, blights, powdery mildew) and apply integrated pest management (IPM) strategies proactively.\n"
          "7.  **Crop Rotation:** Practice crop rotation to break pest and disease cycles and improve soil health.",
    ),
    DiseaseInfoModel(
